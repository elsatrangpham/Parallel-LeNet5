...
void MNIST::read() {
  ...
  read_mnist_data(data_dir + "train-images-idx3-ubyte.gz", train_data);
  read_mnist_data(data_dir + "t10k-images-idx3-ubyte.gz", test_data);
  read_mnist_label(data_dir + "train-labels-idx1-ubyte.gz", train_labels);
  read_mnist_label(data_dir + "t10k-labels-idx1-ubyte.gz", test_labels);
}
